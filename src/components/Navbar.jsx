      ...
      <div className="text-center">
        ...
        <div className="flex justify-center gap-4">
          <button
            ...
            className="px-5 py-2 font-semibold text-gray-700 dark:text-gray-200 bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 rounded-full transition"
          >
            Cancel
          </button>
          <button
            onClick={handleLogout}
            className="px-5 py-2 font-semibold text-white bg-gradient-to-r from-purple-600 to-pink-500 hover:opacity-90 rounded-full shadow-lg transition"
          >
            Yes, Logout
          </button>
        </div>
